...
namespace NCrash.WinForms
{
    partial class Full
	{
		...
		private void InitializeComponent()
		{
			...
			this.ncrashTextBox = new System.Windows.Forms.TextBox();
			this.ncrashLabel = new System.Windows.Forms.Label();
			...
			this.generalTabPage.Controls.Add(this.ncrashTextBox);
			this.generalTabPage.Controls.Add(this.ncrashLabel);
			...
			// ncrashTextBox
			// 
			this.ncrashTextBox.Location = new System.Drawing.Point(307, 182);
			this.ncrashTextBox.Name = "ncrashTextBox";
			this.ncrashTextBox.Size = new System.Drawing.Size(145, 20);
			this.ncrashTextBox.TabIndex = 9;
			// 
			// ncrashLabel
			// 
			this.ncrashLabel.AutoSize = true;
			this.ncrashLabel.Location = new System.Drawing.Point(259, 185);
			this.ncrashLabel.Name = "ncrashLabel";
			this.ncrashLabel.Size = new System.Drawing.Size(37, 13);
			this.ncrashLabel.TabIndex = 8;
			this.ncrashLabel.Text = "NCrash:";
			// 
			// applicationTextBox
			// 
		...
		private System.Windows.Forms.TextBox ncrashTextBox;
		private System.Windows.Forms.Label ncrashLabel;
